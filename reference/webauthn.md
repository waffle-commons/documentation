...
- **base64url discipline.** Every binary field is carried as base64url (via [`Base64Url`](#codec-shared-with-the-bridge)); a stored field that does not strict-decode raises `WebAuthnException`.
