...
> [!WARNING]
> **ALPHA SOFTWARE**
> This version (`v0.1.0-alpha4`) is for **testing and development purposes only**. It has not undergone a formal security audit. Do not use in critical production environments without review.
...
### Solving a Problem?
- [**Secure Your Controller**](how-to/secure-a-controller.md): Configuring Security Levels.
- [**Add Middleware**](how-to/add-middleware.md): Intercepting requests.
